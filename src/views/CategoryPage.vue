              ...
              <div class="col-side">
                  <div class="card">
                      ...
                      <section class="-phm">
                        ...
                        <div class="pfi-w">
                            <div class="pi-w">
                                <input type="number" min="0" placeholder="Min" v-model="min" class="pi">
                            </div>
                            <span class="-phs">-</span>
                            <div class="pi-w">
                  ...
                  <section class="card">
                                ...
                                <div class="-mla-s" @click="isFilterOpen=!isFilterOpen">
                                    ...
                                    <div class="box" v-if="isFilterOpen">
                                        <div class="inbox">
                                            ...
                                            <div class="link" @click="filterBy='Price: Low to High'">
                                                Price: Low to High
                                            </div>
                                            <div class="link" @click="filterBy='Price: High to Low'">
                                                Price: High to Low
                                            </div>
                                        </div>
                                    </div>
                      ...
                      <div class="row">
                          <article class="prd" v-for="(item,i) in items" :key="i" @mouseenter="currentItem = i" @mouseleave="currentItem = null">
                              ...
                              <footer class="action">
                                  <div class="btn-wrap">
                                      <button class="btn" :class="currentItem == i ?'btn-show': null">
                                          Add to Cart
                                      </button>
                                  </div>
                              </footer>
